      ...
      <div className="container mx-auto px-3 sm:px-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 mb-4 sm:mb-6">
          <div className="mb-4 sm:mb-0">
            <h5 className="font-mono text-white mb-2 flex items-center justify-center md:justify-start gap-1 text-[10px]">
              <img src="/promptkat-logo.svg" alt="promptKat Logo" className="w-4 h-4" />
            ...
            <p className="text-[8px] font-mono">your_central_hub_for_high_quality_ai_prompts</p>
          ...
          <div>
            <h5 className="font-mono text-white mb-2 text-[10px]">quick_links</h5>
          ...
          <div>
            <h5 className="font-mono text-white mb-2 text-[10px]">legal_info</h5>
            <ul className="space-y-1">
              <li><Link href="/privacy-policy" className="hover:text-purple-400 transition-colors text-[8px] inline-block py-0.5 font-mono">.privacy_policy</Link></li>
              <li><Link href="/terms-of-service" className="hover:text-purple-400 transition-colors text-[8px] inline-block py-0.5 font-mono">.terms_of_service</Link></li>
              <li><Link href="/contact" className="hover:text-purple-400 transition-colors text-[8px] inline-block py-0.5 font-mono">.contact_us</Link></li>
            </ul>
